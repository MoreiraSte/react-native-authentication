...
export default function Delete({ navigation }) {
    ...
    const click = () =>{
        if(item.id === true){
            itensSelected.deleteItem(item.id)
        }
    }
                ...
                renderItem={({ item }) =>  {
                    return (
                        <View style={styles.pageDelete}>
                            ...
                            <View style={{ backgroundColor: '#0d0', width: 50}}>
                            ...
                            <View style={{ backgroundColor: '#00d', width: 50 }}>
                            ...
                            <View style={{ backgroundColor: '#fff', width: 200 }}>
                                <Text
